...
import com.example.andres.final_2h_g02.ec.edu.uce.controladores.Busqueda;
  ...
  EditText Marca, Placa, Costo;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()== R.id.item1) {
            ...
            //dblite.buscarVh(vehiculos,buscar.getText().toString());
if(dblite.buscarVh(vehiculos,buscar.getText().toString())==1) {
    ...
    Costo.setText(vehiculos.getCosto().toString());

    String seleccion2 = vehiculos.getMatriculado().toString();
    ...
    String seleccion = vehiculos.getColor();
    ...
    String seleccion3 = vehiculos.getEstado().toString();
    if (seleccion3.equals("true")) {
...
*/
                        ...
                        //EditText contiene algún caracter!
                        {
                            ...
                            if (color.getCheckedRadioButtonId() == -1) {
                                ...
                                if (Tipo.getCheckedRadioButtonId() == -1) {
                                    Toast.makeText(this, "Campo Tipo Vacio", Toast.LENGTH_LONG).show();
                                } else {
                                if (matcher.matches()  ) {
                                    ...
                                    if(matcher2.matches()){
                                        ...
                                        for (int i = 0; i < items.size(); i++) {
                                            if(i== indiceProducto){
                                                items.set(i,(new Vehiculo(Placa.getText().toString(),Marca.getText().toString(),fecha,Double.parseDouble(Costo.getText().toString()),estado,ncolor,estado2,ntipo)));
                                        ...
                                        editor.commit();
                                        finish();
                                        dblite.editarVh(buscar.getText().toString(),new Vehiculo(Placa.getText().toString(),Marca.getText().toString(),fecha,Double.parseDouble(Costo.getText().toString()),estado,ncolor,estado2,ntipo));
            ...
            dblite.eliminarVH(buscar.getText().toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Automovil = (RadioButton) findViewById(R.id.rdautomovil2);
        Camioneta = (RadioButton) findViewById(R.id.rdcamioneta2);
        Furgoneta = (RadioButton) findViewById(R.id.rdfurgoneta2);
        Estado = (Switch) findViewById(R.id.swestado2);
        Tipo = (RadioGroup) findViewById(R.id.rdtipo2);
        cargarFechas();
