...
Reserva reserva= new Reserva();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.item4) {
            ...
            if(dblite.buscarVh(vehiculos,Comprobacion.getText().toString())==1) {
   ...
   pueden haber muchas coincidencias. */
    ...
    y de conseguirlas, la cambia y vuelve a hacer la comprobacion */
                ...
                dblite.ingresarReserva(new Reserva(generado, Email.getText().toString(), fechaactual, fecha, total, Celular.getText().toString(),Comprobacion.getText().toString()));

                items.add(new Reserva(generado, Email.getText().toString(), fechaactual, fecha, total, Celular.getText().toString(),Comprobacion.getText().toString()));
                ...
                try {
                   ...
                   // startActivity(intent);
                    ...
                    intent.putExtra("data", "Auto reservado: "+vehiculos.getPlaca()+" valor:"+total+" Placa: "+reserva.getPlacavh());
                    startActivity(intent);
        ...
        if (set != null) {
            for (String s : set) {
                try {
                    ...
                    String placavh = jsonObject.getString("placavh");
                    Reserva myclass = new Reserva(numero, email,posi, posi2, costo, celular,placavh);
