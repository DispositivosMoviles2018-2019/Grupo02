...
//dblite.ingresarReserva(new Reserva("100","asd@asd.com",null,null,10.5,12344));
        ...
        if(data.getCount()==0){
            ...
            while (data.moveToNext()){
                lista2.add(data.getString(0)+"  "+data.getString(1)+"  "+data.getString(2)+"  "+data.getString(3)+"  "+data.getString(4)+"  "+data.getString(5));

                ArrayAdapter<String> adapterM = new ArrayAdapter<>(this, android.R.layout.simple_expandable_list_item_1, lista2);
