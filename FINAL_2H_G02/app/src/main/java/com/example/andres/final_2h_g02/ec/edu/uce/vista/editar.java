...
Date fecha;
                                ...
                                if (color.getCheckedRadioButtonId() == -1) {
                                    ...
                                    if (matcher.matches()) {
                                        ...
                                        if (matcher2.matches()) {
                                            ...
                                            dblite.ingresarVehiculo(new Vehiculo(Placa.getText().toString(), Marca.getText().toString(), fecha, Double.parseDouble(Costo.getText().toString()), estado, ncolor,estado2,ntipo));
                                            items.add(new Vehiculo(Placa.getText().toString(), Marca.getText().toString(), fecha, Double.parseDouble(Costo.getText().toString()), estado, ncolor,estado2,ntipo));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Automovil = (RadioButton) findViewById(R.id.rdautomovil);
        Camioneta = (RadioButton) findViewById(R.id.rdcamioneta);
        Furgoneta = (RadioButton) findViewById(R.id.rdfurgoneta);
        Estado = (Switch) findViewById(R.id.swestado);
        Tipo = (RadioGroup) findViewById(R.id.rdtipo);
