...
Switch Matriculado;
CheckBox Rojo, Plomo, Azul, Verde;
RadioGroup color;
String ncolor;
Boolean estado;
private Spinner dia;
...
Date fecha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Rojo = (CheckBox) findViewById(R.id.rdrojo);
        Plomo = (CheckBox) findViewById(R.id.rdplomo);
        Azul= (CheckBox) findViewById(R.id.rdazul);
        Verde = (CheckBox) findViewById(R.id.rdverde);
