package com.example.andres.ex2h_g02.ec.edu.uce.modelo;
...
public class Bdvehiculos extends SQLiteOpenHelper {
   ...
   // private static final String TABLA_CURSOS = "CREATE TABLE USUARIOS(USUARIO TEXT PRIMARY KEY, CONTRASEÑA TEXT)";
    ...
    private static final String TABLA_CURSOS = "CREATE TABLE USUARIOS(USUARIO TEXT PRIMARY KEY, CONTRASEÑA TEXT)";
    private static final String TABLA_RESERVAS = "CREATE TABLE RESERVAS(NUMERO TEXT PRIMARY KEY, EMAIL TEXT, CELULAR TEXT, FECPRESTAMO TEXT, FECENTREGA TEXT, VALOR TEXT)";
    ...
    public void buscarVh(Vehiculo vehiculos, String codigo){
        //Modo de lectura
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void ingresarReserva(Reserva re){
        ...
        SQLiteDatabase db = getWritableDatabase();
        if (db != null){
            db.execSQL("INSERT INTO RESERVAS VALUES('"+re.getNumero()+"','"+re.getEmail()+"','"+re.getFecPrestamo()+"','"+re.getFecEntrega()+"','"+re.getValor()+"','"+re.getCelular()+"')");
            db.close();
        }
    }
    ...
    public void buscarReserva(Reserva reservas, String codigo){
        //Modo de lectura
        SQLiteDatabase db = getReadableDatabase();
