...
import com.example.andres.ex2h_g02.ec.edu.uce.modelo.Usuario;
       ...
       final Bdvehiculos dblite = new Bdvehiculos(getApplicationContext());
        regist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String validepass =  "[A-Z]{1}"+
                        "[a-z]{4}"+
                        "[0-9]{1}";

                //"^(?=.[0-9])(?=.[A-Z])(?=.*[a-z])(?=\\S+$).{6,}$"
                String pass = contraseña.getText().toString();
                Matcher matcher = Pattern.compile(validepass).matcher(pass);
                if (matcher.matches()) {
                ...
                startActivity(intent);
                    ...
                    Toast.makeText(getApplicationContext(), "Contraseña mal ingresada (Aaaaa1)", Toast.LENGTH_LONG).show();
                }
