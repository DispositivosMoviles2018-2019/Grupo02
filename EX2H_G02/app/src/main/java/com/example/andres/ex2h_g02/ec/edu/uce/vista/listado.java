       ...
       // carros=(TextView) findViewById(R.id.txtcarros);
        ...
        if(data.getCount()==0){
            ...
            while (data.moveToNext()){
                lista.add("Placa: "+data.getString(0).concat("\n")+"Marca: "+data.getString(1).concat("\n")+"Fecha Fab. "+data.getString(2).concat("\n")+"Costo: "+data.getString(3).concat("\n")+"Matriculado: "+data.getString(4).concat("\n")+"Color  "+data.getString(5).concat("\n")+"Estado: "+data.getString(6).concat("\n")+"Tipo: "+data.getString(7));

                // ArrayAdapter<String> adapterM = new ArrayAdapter<>(this, android.R.layout.simple_expandable_list_item_1, lista);
                ArrayAdapter<String> adapterM = new ArrayAdapter<>(this, android.R.layout.simple_list_item_activated_1, lista);
                listaV.setAdapter(adapterM);}
        }
