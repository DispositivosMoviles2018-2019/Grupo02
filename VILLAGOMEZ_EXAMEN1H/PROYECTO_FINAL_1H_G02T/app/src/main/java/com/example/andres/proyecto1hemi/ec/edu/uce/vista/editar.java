...
Date fecha;
                    ...
                    if (Copia == 0) {
                        ...
                        //EditText contiene algún caracter!
                        {
                            ...
                            //EditText contiene algún caracter!
                            {
                                ...
                                if ((azul.isChecked()== FALSE) && (verde.isChecked()== FALSE)&&(rojo.isChecked()== FALSE) &&(plomo.isChecked()== FALSE) ){
                                    ...
                                    if (matcher.matches()) {
                                        ...
                                        if (matcher2.matches()) {
                                            ...
                                            items.add(new Vehiculo(Placa.getText().toString(), Marca.getText().toString(), fecha, Double.parseDouble(Costo.getText().toString()), estado, colores));
                                        } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rojo=(CheckBox) findViewById(R.id.Mrojo);
        verde=(CheckBox) findViewById(R.id.Mverde);
        azul=(CheckBox) findViewById(R.id.Mazul);
        plomo=(CheckBox) findViewById(R.id.Mplomo);
