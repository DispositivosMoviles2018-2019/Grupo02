package com.example.carloscaiza.ccaiza_ex_1h.ec.edu.uce.modelo;
...
public Vehiculo(String placa, String marca,Date fecFabricacion, Double costo, Boolean matriculado, String color){
    ...
    public String toString() {
        ...
        String str = String.valueOf(matriculado);
        return "Placa: " +placa.concat("\n").concat("Marca: ").concat(marca).concat("\n").concat("FecFabri: ").concat(formateador.format(fecFabricacion)).concat("\n").concat("Costo: ").concat(f1.format(costo)).concat("\n").concat("Matriculado: ").concat(str).concat("\n").concat("Color: ").concat(color).concat("\n");
/*     String str;
       return "Placa=" + placa +
                ", Marca=" + marca +
