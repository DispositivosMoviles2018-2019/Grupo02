...
public class listado extends AppCompatActivity {
    ...
    //SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); (dd-MM-yy)--> 31-03-2016
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MMMM-dd");

   // String fecha1="2015-11-13";
   // String fecha2="1998-03-05";
    String fecha1="2015-Nov-13";
    String fecha2="1998-Mar-05";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if(item.getItemId()== R.id.item4)
        {
           ...
           // ArrayAdapter<Vehiculo> adapterM = new ArrayAdapter<Vehiculo>(this, android.R.layout.simple_expandable_list_item_1, items );
            ArrayAdapter<Vehiculo> adapterM = new ArrayAdapter<Vehiculo>(this, android.R.layout.simple_list_item_activated_1, items );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaV = findViewById(R.id.listado);
        //Comparator<Vehiculo> comparar = Collections.reverseOrder();
        Collections.sort(items,new Vehiculo.MyComparator());// Para ordenar
        SharedPreferences.Editor editor = getSharedPreferences("Examen", MODE_PRIVATE).edit();
        ...
        ArrayAdapter<Vehiculo> adapterM = new ArrayAdapter<Vehiculo>(this, android.R.layout.simple_list_item_activated_1, loadFromStorage() );
        listaV.setAdapter(adapterM);
    }
        ...
        if (set != null) {
            for (String s : set) {
                try {
                    ...
                    String fecha = jsonObject.getString("fecfabricacion");
                    Date posi= sdf.parse(fecha);
