...
import com.example.carloscaiza.ccaiza_ex_1h.ec.edu.uce.controladores.Busqueda;
...
//            }
            ...
            if (indiceProducto >= 0) {
                ...
                //dia.setSelection(items.get(indiceProducto).getFecFabricacion().getDay()+1);
                mes.setSelection(items.get(indiceProducto).getFecFabricacion().getMonth());
                //ano.setSelection(items.get(indiceProducto).getFecFabricacion().getYear());
...
//            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Azul = findViewById(R.id.rdazul2);
